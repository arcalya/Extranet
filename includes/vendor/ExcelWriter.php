<?php
     ...
     */
	 ...
	 /*
	 * This Class is used to save the data into microsoft excel format.
	 * It takes data from an array or you can write data column wise.
	 */
	...
	Class ExcelWriter
	{
		...
		* 			then the directory must exist on the system and have been permissioned properly
		* 			to write the file.
		* @Return : On Success Valid File Pointer to file
		* 			On Failure return false	 
		*/
		function open($file)
		{
			...
			{
				$this->error="Error : Another file is open .Close it to save the file";
				return false;
			}	
		...
		/* @Params : Void
		*  @return : Void
		* This function writes the header of Excel file.
		*/
...
EOH;
		...
		*/
		...
		function writeLine($line_arr)
		{
			...
			{
				$this->error="Error : Argument is not valid. Supply a valid Array.";
				return false;
			}
			fwrite($this->fp,"<tr>");
